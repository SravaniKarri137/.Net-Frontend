...
const Designjobs = () => {
  ...
  const fetchJobPostings = async () => {
    try {
      const department = encodeURIComponent("Design & Creative");
  ...
  return (
    ...
    >
      <div className="text-center mb-5">
        ...
        >
          🎨 UI/UX Design Job Opportunities
        </motion.h2>
        <p className="text-muted">Craft beautiful experiences — find your next design adventure!</p>
      </div>
